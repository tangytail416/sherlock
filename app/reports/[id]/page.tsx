...
interface Report {
  ...
  content?: {
    ...
    raw?: string;
    analysis?: string;
    // Legacy markdown format support
    technical_summary?: string;
    threat_classification?: string;
    key_findings?: string[];
    indicators_of_compromise?: string[];
  ...
  const headerContent = (
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl md:text-2xl lg:text-3xl font-bold tracking-tight">{report.title}</h1>
    ...
    <PageLayout header={headerContent}>
      ...
      {report.findings?.sections && typeof report.findings.sections === 'object' && (
            ...
            <Card>
              ...
              <CardContent>
                <div 
                  ...
                  dangerouslySetInnerHTML={{ __html: report.findings.sections.threat_classification }}
                />
              </CardContent>
            </Card>
          )}
		...
		{/*//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/}
          ...
          {report.findings.sections.technical_summary && (
            <Card>
              ...
              <CardContent>
                <div 
                  className="prose prose-sm max-w-none dark:prose-invert overflow-x-auto"
                  dangerouslySetInnerHTML={{ __html: report.findings.sections.technical_summary }}
                />
              </CardContent>
            </Card>
          )}
          ...
          {/* IOCs - HTML */}
          {report.findings.sections.indicators_of_compromise && report.findings.sections.indicators_of_compromise.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
              ...
              <CardContent>
                <div className="space-y-2">
                  {report.findings.sections.indicators_of_compromise.map((ioc: string, idx: number) => (
            ...
            <Card>
              ...
              <CardContent>
                <div 
                  ...
                  dangerouslySetInnerHTML={{ __html: report.findings.sections.conclusion }}
                />
              </CardContent>
            </Card>
          )}
      ...
      {(!report.findings?.sections || typeof report.findings.sections !== 'object') && (
        <>
          {/* Threat Classification & Key Findings */}
          {/* Threat Classification */}
