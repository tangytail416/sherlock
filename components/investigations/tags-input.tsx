...
const DEFAULT_TAGS = {
  classification: ['false-positive', 'confirmed-incident', 'benign', 'inconclusive', 'testing'],
  threatType: ['malware', 'phishing', 'ransomware', 'lateral-movement', 'privilege-escalation', 'data-exfiltration', 'insider-threat', 'suspicious-logon', 'brute-force', 'command-execution'],
  campaign: ['APT29', 'FIN7', 'Carbanak', 'Lazarus', 'Cozy-Bear', 'DarkSide', 'REvil'],
};
